        ...
        <header>
            ...
            <nav id="navbar">
                <ul>
                    ...
                    <li id="link_bio"><a href="index.php?action=getBio"><i class="far fa-user-circle"></i></a></li>
                    <li id="link_login"><a href="index.php?action=loginAdmin"><i class="fas fa-power-off"></i></a></li>
                </ul>
            </nav>
