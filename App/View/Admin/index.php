...
?>
    ...
    <?php if (isset($errors) && in_array(Episodes::AUTEUR_INVALIDE, $errors)) echo 'L\'auteur est invalide.<br />'; ?>

    Auteur : <input type="text" name="auteur" value="<?php if (isset($episodes)) echo $episodes->auteur(); ?>" /><br />
